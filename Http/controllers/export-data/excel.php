...
//Column headers
$fields = array('#', 'NAME', 'GRADE', 'STAFF ID', 'TELEPHONE', 'STATUS', 'REMARKS', 'UNIT', 'STAFF TYPE');
...
if ($staff) {
    foreach ($staff as $st) {
        ...
        $rawData = array($count, $st['fname'] . ' ' . $st['oname'] . ' ' . $st['lname'], $st['grade'], $st['staff_id'], $st['phone'], $status, $st['remarks'], $st['unit_name'], $st['staff_type']);
//dd($rawData);
