...
<div class=" flex-col justify-center px-6 lg:px-8">
  ...
  <div class=" sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" method="POST">
        ...
        <div class="text-red-600 text-xs mt-3"><?=isset($errors['username']) ? $errors['username'] : ""  ?> </div>
      <div>
        <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Username Or Email</label>
        <div class="mt-2">
      ...
      <div>
        ...
        <div class="mt-2">
          <input id="password" name="password" type="password" value="<?=$data['password'] ?? '' ?>" autocomplete="current-password" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
        </div>
      </div>
