        ...
        <div class="space-y-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="mt-2">
                    ...
                    <input style="width:450px" type="text" name="title" id="title" autocomplete="title" value="<?=$title ?? ""?>" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
                ...
                <div class="mt-2">
                    <textarea style="width:450px" id="body" name="body" rows="3" class="block  rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder=""> <?=$body ?? ""?></textarea>
